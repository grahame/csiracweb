/**
 * Drawing the cathode ray tube monitors.
 *
 ...
 *
 * This is the drawing on its own, with nothing of the browser in it beyond a
 * canvas context: `Crt.tsx` gives it a canvas on the page, sixty times a
 * second, and `tools/make-og.mjs` gives it one to write a PNG out of. The
 * preview image the site is shared under therefore shows the same tubes the
 * page does, drawn by the same code, rather than a picture of them.
 */
 ...
 */
export const BANK_WIDTH = 630;
export const BANK_HEIGHT = 140;
...
export function drawBank(ctx: CanvasRenderingContext2D, tubes: readonly Tube[]) {
